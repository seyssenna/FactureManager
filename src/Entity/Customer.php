...
class Customer
{
     ...
     * @Groups({"customers_read", "invoices_read"})
     * @Assert\Length(min=2, minMessage="Le prénom doit faire entre 2 et 255 caractères", max=255, maxMessage="Le prenom doit faire entre 2 et 255 caractères")
     */
    private $firstName;
    ...
    /**
     * Retrieve invoices total amount
     * @Groups({"customers_read"})
     * @return float
     */
    ...
    /**
     * Retrieve total amount of unpaid invoices
     * @Groups({"customers_read"})
     * @return float
     */
